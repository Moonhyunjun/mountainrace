...
2. **2027 대회 기대감 조성** — 히어로의 COMING SOON 티저(일정 확정 시 카운트다운 자동 전환), 2026 대회 리캡(참가자 800+, 코스 기록),
...
- `imweb/widget-countdown.html` — 기존 페이지에 2027 티저 배너만 추가 (일정 확정 전엔 COMING SOON, 날짜 확정 시 카운트다운으로 자동 전환)
...
| 항목 | 위치 | 방법 |
|---|---|---|
| 2027 대회 날짜 | `js/main.js` 맨 위 `RACE_DATE_2027` | **확정 전에는 `null`** → 히어로에 COMING SOON 배너 표시. 확정되면 `new Date('2027-XX-XXT06:00:00+09:00')`(KST)로 넣으면 자동으로 카운트다운 전환 |
