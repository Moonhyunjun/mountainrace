---
name: ui-ux-pro-max
description: Design intelligence for building professional UI/UX. Provides searchable databases of UI styles, color palettes, font pairings, UX guidelines, and stack-specific best practices, plus a design-system generator. Use when designing pages or components, choosing styles/colors/typography, reviewing UI for UX and accessibility issues, or implementing responsive layouts and motion.
---

# UI/UX Pro Max

Design intelligence for building professional UI/UX. Provides searchable databases of UI styles, color palettes, font pairings, UX guidelines, and stack-specific best practices, plus a design-system generator. Use when designing pages or components, choosing styles/colors/typography, reviewing UI for UX and accessibility issues, or implementing responsive layouts and motion.
